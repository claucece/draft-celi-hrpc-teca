...
Discussion of this work occurs on the [Human Rights Protocol Considerations
Research Group mailing list](mailto:hrpc@irtf.org)
([archive](https://mailarchive.ietf.org/arch/browse/hrpc),
[subscribe](https://mailman.irtf.org/mailman/listinfo/hrpc)).
...
[Research Group documents](https://datatracker.ietf.org/rg/hrpc/documents/).
